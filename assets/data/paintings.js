/* The register of scrolls.
   ...
   Three scrolls have no freely licensed scan anywhere: 春游赋诗图, 林峦积翠图
   and 江山行旅图. For those, and only those, the images here come from the
   ...
   rather than on licence:
     ...
     后赤壁赋图  Commons has the whole 22,175px scroll; the museum's page has
                only a 4,001px section of it.
     晴峦萧寺图  the two are the same Google scan; Commons' is 2010x4001 against
                the museum's 2009x4000, one pixel larger.

   渔父图 is not on the exhibition page at all, so Commons is the only source. */
...
window.PAINTINGS = {
  default: 'qianli',
  items: [
    { slug:'qianli', zh:'千里江山图', en:'A Thousand Li of Rivers and Mountains',
    ...
    { slug:'yufu', zh:'渔父图', en:"Fishermen's Evening Song",
      artist:{zh:'许道宁', en:'Xu Daoning'}, dates:'970–1052', dynasty:{zh:'北宋', en:'Northern Song'},
    ...
    { slug:'qinglan', zh:'晴峦萧寺图', en:'A Solitary Temple Amid Clearing Peaks',
    ...
    { slug:'houchibi', zh:'后赤壁赋图', en:'Illustration to the Second Prose Poem on the Red Cliff',
      artist:{zh:'乔仲常', en:'Qiao Zhongchang'}, dates:'active c.1090–1120', dynasty:{zh:'北宋', en:'Northern Song'},
      museum:{zh:'纳尔逊-阿特金斯艺术博物馆', en:'The Nelson-Atkins Museum of Art'},
    ...
    { slug:'chunyou', zh:'春游赋诗图', en:'Composing Poetry on a Spring Outing',
      artist:{zh:'（传）马远', en:'Attributed to Ma Yuan'}, dates:'active 1189–1225',
    ...
    /* 林峦积翠图, not 千里江山图. The museum's own Chinese title is 宋 江参 林峦积翠,
       and the collision is worse than it first looks: 千里江山图 names Wang Ximeng's
    ...
    { slug:'linluan', zh:'林峦积翠图', en:'Verdant Mountains',
      artist:{zh:'江参', en:'Jiang Shen'}, dates:'c.1090–1138', dynasty:{zh:'南宋', en:'Song'},
      museum:{zh:'纳尔逊-阿特金斯艺术博物馆', en:'The Nelson-Atkins Museum of Art'},
